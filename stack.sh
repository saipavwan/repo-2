...
timeout 20s curl -NIs http://test.jenkins.columbiadevops.com/ | head -n 1 >> site_test_jenkins_test
...
#3for i in `cut -d':' -f1 /home/jenkins/dashboard/workspace/site_monitor_feed`
#do
#inplace="${i}"
